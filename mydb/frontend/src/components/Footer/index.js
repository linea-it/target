        ...
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item md={6} sx={{ textAlign: "left", mb: 2 }}>
            ...
            >
              ...
              >
                <LinkedInIcon
                  sx={{ color: "#283664", "&:hover": { color: "#0077B5" } }}
                />
              </IconButton>
              <IconButton
              ...
              >
                <XIcon
                  sx={{ color: "#283664", "&:hover": { color: "#1DA1F2" } }}
                />
              </IconButton>
              <IconButton
              ...
              >
                <InstagramIcon
                  sx={{ color: "#283664", "&:hover": { color: "#E1306C" } }}
                />
              </IconButton>
              <IconButton
              ...
              >
                <YouTubeIcon
                  sx={{ color: "#283664", "&:hover": { color: "#FF0000" } }}
                />
              </IconButton>
              <IconButton
              ...
              >
                <FacebookIcon
                  sx={{ color: "#283664", "&:hover": { color: "#1877F2" } }}
                />
              </IconButton>
            </Box>
          </Grid>
